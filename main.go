...
func main() {
	...
	case 2:
		var nNumbers []int
		var nNumber int
		fmt.Println("Введите числа, делители которых необходимо найти, через пробел либо на отдельных строках:",
			"\n(чтобы остановить ввод чисел, введите любой символ не являющийся цифрой)")
		...
		fmt.Println(res)
	case 3:
		fmt.Println("Введите минимум и максимум, между которыми нужно найти простые числа, через пробел (например: 10 20):")
		var min, max int
